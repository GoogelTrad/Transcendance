...
class GameSerializer(serializers.ModelSerializer):
    class Meta:
        model = Game
        fields = ['id', 'date', 'timeSeconds', 'timeMinutes', 'scoreMax' ,'score_player_1', 'score_player_2', 'player1', 'player2', 'winner', 'loser', 'status', 'elo_Player1', 'elo_Player2', 'isInTournament', 'tournamentCode', 'IA']
